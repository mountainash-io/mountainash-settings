...
class SettingsManager:
    ...
    def __init__(self,
        ...
        # pass        
        self.settings_class: SettingsParameters = settings_class
        self.app_settings_objects: dict[Any, BaseSettings] = {}


    # @classmethod
    def get_settings_object(self, settings_parameters: str) -> BaseSettings:
        """
        ...
        obj_settings: Optional[BaseSettings] = self.app_settings_objects.get(settings_parameters, None)

        if isinstance(obj_settings, BaseSettings):
            return obj_settings
        else:
            raise ValueError(f"Configuration for namespace '{settings_parameters.namespace}' found, but is not an BaseSettings object.")
    ...
    def is_namespace_initialised(self, settings_parameters: SettingsParameters) -> bool:
        ...
        return settings_parameters.__hash__() in self.app_settings_objects.keys()
    ...
    def get_or_create_settings(self, 
        ...
        #Otherwise We have a new config to create
            ...
            self.app_settings_objects[settings_parameters.__hash__()] = obj_settings
